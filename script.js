async function fetchGitHubProfile(){
    ...
    try {
        ...
        document.getElementById('profile-image').src = userData.avatar.url;
        ...
        document.getElementById('profile-repos').innerText = `Public Repositories: ${userData.public.repos}`;
